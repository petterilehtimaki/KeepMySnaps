...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    short:
      "Don't unzip it. Drop it here exactly as it arrived. It's read in the browser tab you're already looking at, and nothing is sent anywhere.",
    long: [
  ...
  },
  {
    ...
    long: [
      ...
      "Videos get the same treatment, the hard way. There is nowhere in an MP4 to put a picture, so the overlay has to become part of the frames: the video is decoded, the caption drawn onto every frame, and the whole thing encoded again, on your machine, with the audio copied across untouched. Videos have no EXIF, so the capture time goes into the MP4's own header instead (the field Apple Photos, iCloud and Google Photos read for a video's date), as well as into the filename.",
      ...
      "Files come out named by capture time, like 2019-04-02_09-15-30.jpg, in UTC, because UTC is the only thing Snapchat records. Alongside them you get keepmysnaps-index.csv listing every date and coordinate as plain text, in case you'd rather do something else with it.",
