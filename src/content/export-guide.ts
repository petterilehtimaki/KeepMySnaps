...
export const GUIDE: GuideStep[] = [
  ...
  },
  {
    ...
    body: [
      "Settings is long. You'll pass My Account at the top, then Public Profile Settings, then a whole section called Additional Services. None of that is what you want. Keep going until the heading Privacy Controls appears.",
  ...
  {
    n: "9",
    title: "Open Your exports instead of submitting a new request",
    body: [
